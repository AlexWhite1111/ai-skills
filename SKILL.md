...
description: Proactively use whenever the user's main goal is to understand an idea, mechanism, derivation, causal relation, model, theorem, or unfamiliar knowledge—not only when they explicitly ask for tutoring. Trigger for ordinary “explain,” “why,” “how does this work,” “teach me,” “help me understand,” and concept-comparison requests across technical, scientific, and humanistic domains. Favor this skill when a default response might become a list of definitions, facts, steps, or bullet points without a learning progression; when uncertain between narrative teaching and a reference-style summary, choose narrative teaching. Also trigger for multi-turn learning, intuition plus rigor, misconception repair, jumping-step complaints, requests to slow down, theorem boundaries, Veritasium/真理元素-style structure, or narrative-corpus use. Do not use for factual lookup, simple translation, pure execution or code/file changes with no teaching goal, or explicit requests for only an answer, checklist, or reference list.
---
